    ...
    return (
      <>
        <div class="Container">
          ...
          >
            <div
              class="col-md-3 col-lg-3 col-sm-3 hidden-xs"
              style={{ height: "70px" }}
            >
              <div class="Header">
                <div id="header_txt">
                  <Link to="/">
                    <h1 className="mt-3 text-primary">xislo</h1>
                  </Link>
                </div>
              </div>
            </div>
            <div
              class="col-md-9 col-lg-9 col-sm-9 d-none d-lg-block"
        ...
        <div class="Terms">
          <div id="terms_txt">
            ...
            <p style={{ color: "#333" }}>Last updated: September 10, 2020</p>
            <p style={{ color: "#333" }}>
            ...
            <ul>
              ...
              <li>
                <p style={{ color: "#333" }}>
                  <em>Country</em> refers to: Florida, United States
                </p>
              </li>
              <li>
                <p style={{ color: "#333" }}>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to Xislo LLC.
                </p>
              </li>
              <li>
                <p style={{ color: "#333" }}>
              ...
              <li>
                <p style={{ color: "#333" }}>
                  <em>Service</em> refers to the Website.
                </p>
              </li>
              <li>
                <p style={{ color: "#333" }}>
              ...
              <li>
                <p style={{ color: "#333" }}>
                  <em>Website</em> refers to Xislo, accessible from{" "}
                  <a
                    href="http://www.xislo.com/"
